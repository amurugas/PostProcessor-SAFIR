"""
tests/test_database_queries_thermal.py
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Unit tests for database/queries_thermal.py.

Mirrors test_db_queries_thermal.py but imports from the new package location.
...
import database.queries_thermal as dbq
