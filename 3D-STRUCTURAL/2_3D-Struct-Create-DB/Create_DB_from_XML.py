...
class DatabaseManager:
    ...
    def create_tables(self):
        with self.connect() as conn:
           ...
           CREATE TABLE IF NOT EXISTS model_data (
            ...
            CREATE TABLE IF NOT EXISTS beam_fiber_stresses (
                id INTEGER PRIMARY KEY AUTOINCREMENT,
                timestamp_id INTEGER NOT NULL,
                beam_id INTEGER NOT NULL,
                gauss_point INTEGER NOT NULL,
                fiber_index INTEGER NOT NULL,
                stress REAL
            );

            CREATE TABLE IF NOT EXISTS beam_fiber_strains (
                id INTEGER PRIMARY KEY AUTOINCREMENT,
                timestamp_id INTEGER NOT NULL,
                beam_id INTEGER NOT NULL,
                gauss_point INTEGER NOT NULL,
    ...
    def clear_database(self):
        ...
        with self.connect() as conn:
            ...
            DELETE FROM beam_fiber_stresses;
            DELETE FROM beam_fiber_strains;    
...
class FileParser:
    def __init__(self, db_manager):
        ...
        # ===== CHANGED: streaming, memory-safe =====

    def parse_xml_data(self, xml_file_path):
        # Streaming, big-file-friendly parser
        ...
        logging.info("Streaming parse complete.")
...
if __name__ == "__main__":
    ...
    db_path = 'C:\\Users\\am1\\Documents\\_LocalWorkspace\\PBD_Fire\\Studies\\Rufusblock\\TMA-Study\\3x3Model\\OutputDB\\S2A-9_Bays.db'
    xml_path = 'C:\\Users\\am1\\Documents\\_LocalWorkspace\\PBD_Fire\\Studies\\Rufusblock\\TMA-Study\\3x3Model\\S2A-9_Bays.xml'
    fct_path = 'C:\\Users\\am1\\Documents\\_LocalWorkspace\\PBD_Fire\\Studies\\Rufusblock\\TMA-Study\\3x3Model\\S2A.fct'
