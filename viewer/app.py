...
Launch with::
    ...
    bokeh serve viewer/app.py --show --allow-websocket-origin=*
...
``--args`` flag::
    ...
    # -- or --
    bokeh serve viewer/app.py --show --allow-websocket-origin=* --args --db C:\\path\\to\\Raw.db

All SQL queries are kept in ``db_queries.py``.
